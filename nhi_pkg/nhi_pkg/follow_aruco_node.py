...
class TurtleBotAruco(Node):
    ...
    def handle_pose(self, marker_pose):
        ...
        #------------------------------------------------
        tag_distance = self.get_tag_distance(marker_pose.position.z, marker_pose.position)
        tag_angle = self.get_tag_angle(marker_pose.position.z, marker_pose.position)
